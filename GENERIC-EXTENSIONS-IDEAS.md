...
Pack раскрывается в tuple, structural union и другом списке типов:
...
синтезировать для structural union. Компилятор создаёт скрытый structural union и dispatch по его
...
5. Идентичность анонимного opaque-результата и синтезированного structural union.
