...
стрелки. Общие правила — [перенос строк](operators.md#перенос-строк). Тело в `{ }` кончается на своей
...
Первый `take connection` в capture list передаёт локальное значение в окружение
