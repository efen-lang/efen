...
- **Сопоставление с образцом** — мощный switch с pattern matching
...
### [3. Switch и Pattern Matching](switch.md)
...
2. **Предпочитайте switch длинным if-else цепочкам** когда проверяете одно значение
...
- ✅ Pattern matching с where условиями
- ✅ Отсутствие проваливания в switch по умолчанию
- ✅ Обязательная полнота покрытия в switch
- ✅ Guard для раннего выхода
