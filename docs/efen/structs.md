...
Структуры являются типами-значениями, что означает копирование при присваивании.
...
Efen автоматически применяет copy-on-write для больших структур:
...
| Копирование | Автоматическое | Разделение памяти |
| Наследование | Нет | Да |
