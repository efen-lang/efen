...
> Исследование форм хранения предшествует текущему синтаксису дескрипторов
> памяти. Примеры `storage` ниже не являются нормативным синтаксисом исходного
> языка. Текущая основа задана в
