...
Приведённый ниже `storage`-синтаксис относится к более раннему исследованию и
ещё не перенесён на текущие [memory descriptors](memory/addresses.md). Он не
является нормативным surface syntax.
